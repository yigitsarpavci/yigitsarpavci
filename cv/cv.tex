...
\entry{Systems \& CPU Scheduling --- \textmd{x86-64 Assembly, GNU Toolchain, Linux Syscalls, Process Scheduling, Multithreading (Pthreads), Makefile, LaTeX}}{}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=1pt]
...
\sechead{Skills}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=2pt]
   \item \desc{\textbf{Programming:} JavaScript}
   \item \desc{\textbf{AI \& Development:} AI-Assisted Development}
   \item \desc{\textbf{Tools \& Ecosystem:} Linux/Unix, Git/GitHub, ccache, MS Office}
