...
\entry{Enterprise Admin Dashboard --- \textmd{Next.js 15+, JavaScript, Prisma, Tailwind CSS, Framer Motion}}{}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=1pt]
...
\entry{Systems \& CPU Scheduling --- \textmd{x86-64 Assembly, GNU Toolchain, Linux Syscalls, Process Scheduling, Multithreading (Pthreads)}}{}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=1pt]
...
\sechead{Skills}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=2pt]
   \item \desc{\textbf{Low-Level \& Systems:} Memory Management}
   \item \desc{\textbf{AI \& Development:} AI-Assisted Development}
   \item \desc{\textbf{Tools \& Ecosystem:} Linux/Unix, Git/GitHub, ccache, Makefile, LaTeX, MS Office}
