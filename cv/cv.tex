...
\entry{Mobile Developer Intern at Smash Mate}{06/2026 -- Present}
\begin{itemize}[leftmargin=1.1em, itemsep=0pt, parsep=0pt, topsep=2pt]
   \item \desc{Joined a fast-moving sports-tech startup to develop a cross-platform mobile application for the padel community. Contributing to the product's core features using React, React Native, and Java.}
\end{itemize}
\vspace{2pt}
